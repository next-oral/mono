    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="h-auto p-0 hover:bg-transparent">
          <Avatar>
            <AvatarFallback className="capitalize">{email.charAt(0)}</AvatarFallback>
          </Avatar>
          <ChevronDownIcon
            size={16}
      ...
      <DropdownMenuContent className="max-w-64">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={onClick} variant="destructive" className="cursor-pointer">
