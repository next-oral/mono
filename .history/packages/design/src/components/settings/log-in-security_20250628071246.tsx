                    ...
                    <fieldset>
                      ...
                      <div className="flex items-center gap-3 border border-secondary rounded-full overflow-hidden">
                        ...
                        <span className="flex-grow flex gap-2 items-center rounded-e-full">
                         ...
                         <span className="text-xs font-normal">Start time{new Date(deviceSessions.find(({os, deviceName})=> os === getCurrentDeviceInfo().os || deviceName === getCurrentDeviceInfo().deviceName)?.lastLogin ?? "").toLocaleDateString}</span>
                        </span>
                      </div>
                    </fieldset>
                  </div>
