...
import { LaptopIcon, MonitorIcon, SmartphoneIcon, AppleIcon, Grid2X2XIcon} from "lucide-react";
import { useForm } from "react-hook-form";
import { z } from "zod";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faLinux, faApple, faAndroid, faWindows, faAppStoreIos } from "@fortawesome/free-brands-svg-icons";
      ...
      >
              ...
              <section className="grid grid-cols-1 sm:grid-cols-2 max-sm:gap-5">
                ...
                <div className="border-secondary flex-grow gap-2 rounded-lg border px-4 py-8">
                  <div className="grid w-full grid-cols-2 items-center gap-2 sm:w-[80%] lg:w-[60%]">
                    <fieldset>
                      <legend className="mb-5 font-semibold">Your current session</legend>
        ...
        <div key={idx} className="flex items-center gap-2 py-2">
          ...
          <span className="text-xs text-muted-foreground ml-4">{session.lastLogin}</span>
                      ...
                      {/* <span className="border-r rounded-s-full bg-secondary p-2"><LaptopIcon className="size-4" /></span> */}
