              ...
              <Form {...otpForm}>
                <form onSubmit={otpForm.handleSubmit(handleOtpSubmit)}>
                  ...
                  <div className="mt-5 grid items-center justify-between gap-5 md:grid-cols-2">
                    ...
                    <div className="border-secondary/80 bg-secondary/60 flex items-center justify-between rounded-lg border px-2 py-1.5 lg:ml-auto">
                      ...
                      <Tooltip>
                        ...
                        >
                          <CopyIcon className="size-5 opci8" />
                        </TooltipTrigger>
