            ...
            <div className="border-secondary rounded-lg border p-2 sm:p-3 md:col-span-2">
              <Form {...otpForm}>
                <form onSubmit={otpForm.handleSubmit(handleOtpSubmit)}>
                  ...
                  {/* Step 3 */}
                  <div className="mt-5 grid items-center justify-between gap-5 lg:grid-cols-2 lg:ml-auto">
                    ...
                    <div className="max-sm:w-full max-lg:w-[60%]">
                    <CustomOtpField
                      name="code"
                  ...
                  <div className="flex mt-8">
                    ...
                    <Button
                      type="submit"
                      className="ml-ausize-fit px-[12px] py-[8px]"
    ...
    <AnimatePresence>
      ...
      >
        <div className="flex w-full flex-col gap-[40px] px-2 sm:px-4">
          {showEnableOtpAuth ? (
            <EnableOtpAuth setShowEnableOtpAuth={setShowEnableOtpAuth} />
          ) : (
            <>
              {/* Password Update */}
                  ...
                  <div className="grid w-full grid-cols-2 items-center gap-2">
                    <fieldset>
                      ...
                      <div className="border-secondary flex items-center gap-3 overflow-hidden rounded-full border">
                        ...
                        <span className="flex flex-grow items-center gap-2 rounded-e-full">
