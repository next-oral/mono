          ...
          {showEnableOtpAuth ? (
            ...
            <>
              ...
              <section className="grid grid-cols-1 max-sm:gap-5 md:grid-cols-2">
                ...
                <div className="border-secondary max-md:w-fu flex-grow gap-2 rounded-lg border px-4 py-8">
                  <div className="grid w-full grid-cols-2 items-center gap-2">
                    <fieldset className="bg-primary w-full">
                      ...
                      <div className="border-secondary flex items-center gap-3 overflow-hidden rounded-full border">
                        ...
                        <span className="flex flex-grow flex-wrap items-center gap-2 rounded-e-full">
