                ...
                <div className="border-secondary flex-grow gap-2 rounded-lg border px-4 py-8">
                  <div className="grid w-full grid-cols-2 items-center gap-2 sm:w-[80%] lg:w-[60%]">
                    <fieldset>
                      ...
                      <div className="flex items-center border border-secondaryrounded-full">
                        <span className="border-r  bg-secondary py-1 px-2">{getDeviceIcon(getCurrentDeviceInfo().os)}</span>
