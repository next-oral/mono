...
import { truncateText } from "@/lib/utils" // Import truncateText function
          ...
          {showSeeAll ? (
            ...
            hasNumberOfRows && (
              <div className="flex items-center gap-2">
                ...
                <Select value={String(pageSize)} onValueChange={(value: string) => handlePageSizeChange(Number(value))}>
                    ...
                    <TableRow key={autoGeneratedId} className={cn(isSelected && "bg-accent/50", computedRowClassName)}>
                      ...
                      {selectable && (
                        <TableCell>
                          <Checkbox
                            checked={isSelected}
                            onCheckedChange={(checked: boolean) => handleSelectRow(autoGeneratedId, !!checked)}
