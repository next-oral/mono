      ...
      <Body className="m-0 bg-gray-50 p-0 font-sans">
        <Container className="mx-auto my-10 max-w-[600px] rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <Section className="mb-5 text-center">
            ...
            <Img src="./next-oral.png" alt="Next Oral Logo" width="200" height="60" className="mx-auto"/>
          </Section>
          ...
          {/* Main Content */}
          <Section>
            <Heading as="h2" className="my-8 text-center text-2xl font-semibold text-gray-800">
              Verify Your Account
            </Heading>
