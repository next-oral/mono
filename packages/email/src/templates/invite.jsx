...
export function OrgInviteEmail({ organizationName = "Next Dental", inviterName = "Dr. Jefferson", inviteLink = "https://yourapp.com/invite/accept?token=123", }) {
    return (<Tailwind>
      <Html>
        <Head />
        ...
        <Body className="bg-gray-100 font-sans text-gray-800">
          <Container className="mx-auto max-w-[600px] rounded-md bg-white p-6 shadow-md">
            ...
            <Section className="my-6 text-center">
              <Link href={inviteLink} className="inline-block rounded bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-700">
                Accept Invitation
              </Link>
