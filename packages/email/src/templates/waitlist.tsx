...
export default function WaitlistEmail({
  ...
  return (
    <Tailwind>
      <Html>
        <Head />
        <Preview>Welcome to the Next Oral Waitlist</Preview>
        <Body className="bg-gray-50 font-sans text-gray-800">
          <Container className="mx-auto max-w-[600px] bg-white p-5">
            <Section className="rounded-lg bg-white shadow-sm">
              ...
              <Section className="px-9 py-6">
                ...
                <Text className="mb-4 text-base text-gray-600">
                  Hi {name}, thank you for your interest in Next Oral! We're
                  excited to have you join our waitlist. We'll notify you as
                  soon as we're ready to welcome you to our platform.
                </Text>
                ...
                <Section className="mb-6">
                  ...
                  <Text className="mb-2 text-sm text-gray-600">
                    • You'll get early access to our platform
                  </Text>
              ...
              <Section className="px-9 py-6">
                <Text className="m-0 text-sm text-gray-600">
                  While you wait, follow us on social media for the latest
                  updates and dental practice management tips.
                </Text>
              </Section>
            </Section>
            ...
            <Text className="mt-6 px-5 text-center text-xs text-gray-500">
              ...
              <Link
                href="https://nextoral.com/privacy"
