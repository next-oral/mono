...
export const schema = {
        ...
        "patient": {
            ...
            "columns": {
                ...
                "title": {
                    "type": "string",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "patient", "title">
                },
                "occupation": {
                    "type": "string",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "patient", "occupation">
                },
                "gender": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "patient", "gender">
                },
                "email": {
                    "type": "string",
                    "optional": true,
        ...
        "tooth": {
            ...
            "columns": {
                ...
                "toothTypeId": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "tooth", "toothTypeId">,
                    "serverName": "tooth_type_id"
                },
                "notation": {
                    "type": "string",
                    "optional": true,
        ...
        "toothSurface": {
            ...
            "columns": {
                ...
                "name": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothSurface", "name">
                },
                "description": {
                    "type": "string",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothSurface", "description">
                },
                "createdAt": {
                    "type": "number",
                    "optional": true,
        ...
        "toothType": {
            ...
            "columns": {
                "id": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothType", "id">
                },
                "name": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothType", "name">
                },
                "description": {
                    "type": "string",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothType", "description">
                },
                "createdAt": {
                    "type": "number",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothType", "createdAt">,
                    "serverName": "created_at"
                },
                "updatedAt": {
                    "type": "number",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothType", "updatedAt">,
                    "serverName": "updated_at"
                }
            },
            "primaryKey": ["id"],
            "serverName": "tooth_type"
        },
        "toothTypeSurface": {
            "name": "toothTypeSurface",
            "columns": {
                "id": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothTypeSurface", "id">
                },
                "toothTypeId": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothTypeSurface", "toothTypeId">,
                    "serverName": "tooth_type_id"
                },
                "surfaceId": {
                    "type": "string",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothTypeSurface", "surfaceId">,
                    "serverName": "surface_id"
                },
                "createdAt": {
                    "type": "number",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothTypeSurface", "createdAt">,
                    "serverName": "created_at"
                },
                "updatedAt": {
                    "type": "number",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "toothTypeSurface", "updatedAt">,
                    "serverName": "updated_at"
                }
            },
            "primaryKey": ["id"],
            "serverName": "tooth_type_surface_mapping"
        },
        "treatmentItem": {
            "name": "treatmentItem",
            "columns": {
    ...
    "relationships": {
        ...
        "missingTooth": {
            "patient": [{ "sourceField": ["patId"], "destField": ["id"], "destSchema": "patient", "cardinality": "one" }],
            "tooth": [{ "sourceField": ["toothId"], "destField": ["id"], "destSchema": "tooth", "cardinality": "one" }]
        },
        "organization": {
        ...
        "toothSurface": {
            "toothTypeSurfaces": [{ "sourceField": ["id"], "destField": ["surfaceId"], "destSchema": "toothTypeSurface", "cardinality": "many" }]
        },
        "teamMember": {
        ...
        "tooth": {
            "toothType": [{ "sourceField": ["toothTypeId"], "destField": ["id"], "destSchema": "toothType", "cardinality": "one" }],
            "missingTeeth": [{ "sourceField": ["id"], "destField": ["toothId"], "destSchema": "missingTooth", "cardinality": "many" }],
            "toothMovements": [{ "sourceField": ["id"], "destField": ["toothId"], "destSchema": "toothMovement", "cardinality": "many" }]
        },
        "toothType": {
            "teeth": [{ "sourceField": ["id"], "destField": ["toothTypeId"], "destSchema": "tooth", "cardinality": "many" }],
            "toothTypeSurfaces": [{ "sourceField": ["id"], "destField": ["toothTypeId"], "destSchema": "toothTypeSurface", "cardinality": "many" }]
        },
        "toothTypeSurface": {
            "toothType": [{ "sourceField": ["toothTypeId"], "destField": ["id"], "destSchema": "toothType", "cardinality": "one" }],
            "surface": [{ "sourceField": ["surfaceId"], "destField": ["id"], "destSchema": "toothSurface", "cardinality": "one" }]
        },
        "treatmentItem": {
...
/**
 * Represents a row from the "toothType" table.
 * This type is auto-generated from your Drizzle schema definition.
 */
export type ToothType = Row<Schema["tables"]["toothType"]>;
/**
 * Represents a row from the "toothTypeSurface" table.
 * This type is auto-generated from your Drizzle schema definition.
 */
export type ToothTypeSurface = Row<Schema["tables"]["toothTypeSurface"]>;
/**
