...
export const schema = {
        ...
        "appointment": {
            ...
            "columns": {
                ...
                "notes": {
                    "type": "string",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "appointment", "notes">
                },
                "type": {
                    "type": "string",
                    "optional": true,
                ...
                "time": {
                    "type": "number",
                    "optional": false,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "appointment", "time">
                },
                "createdAt": {
                    "type": "number",
                    "optional": true,
        ...
        "formResponse": {
            ...
            "columns": {
                ...
                "responseData": {
                    "type": "json",
                    "optional": true,
                    "customType": null as unknown as ZeroCustomType<ZeroSchema, "formResponse", "responseData">,
    ...
    "relationships": {
        ...
        "clinicalNote": {
            "appointment": [{ "sourceField": ["appointmentId"], "destField": ["id"], "destSchema": "appointment", "cardinality": "one" }],
            "dentist": [{ "sourceField": ["dentistId"], "destField": ["id"], "destSchema": "dentist", "cardinality": "one" }]
        },
        "dentist": {
        ...
        "form": {
            "responses": [{ "sourceField": ["id"], "destField": ["formId"], "destSchema": "formResponse", "cardinality": "many" }]
        },
        "formResponse": {
            "form": [{ "sourceField": ["formId"], "destField": ["id"], "destSchema": "form", "cardinality": "one" }],
            "patient": [{ "sourceField": ["patId"], "destField": ["id"], "destSchema": "patient", "cardinality": "one" }]
        },
        "invitation": {
        ...
        "tooth": {
            "surfaces": [{ "sourceField": ["id"], "destField": ["toothId"], "destSchema": "toothSurface", "cardinality": "many" }],
        ...
        "treatmentItem": {
            ...
            "appointment": [{ "sourceField": ["appointmentId"], "destField": ["id"], "destSchema": "appointment", "cardinality": "one" }],
            "dentist": [{ "sourceField": ["dentistId"], "destField": ["id"], "destSchema": "dentist", "cardinality": "one" }],
            "toothSurface": [{ "sourceField": ["toothSurfaceId"], "destField": ["id"], "destSchema": "toothSurface", "cardinality": "one" }],
            "diagnosis": [{ "sourceField": ["diagnosisId"], "destField": ["id"], "destSchema": "diagnosis", "cardinality": "one" }],
            "procedure": [{ "sourceField": ["procedureId"], "destField": ["id"], "destSchema": "procedure", "cardinality": "one" }]
        },
        "treatmentPlan": {
            "patient": [{ "sourceField": ["patId"], "destField": ["id"], "destSchema": "patient", "cardinality": "one" }],
            "dentist": [{ "sourceField": ["dentistId"], "destField": ["id"], "destSchema": "dentist", "cardinality": "one" }],
