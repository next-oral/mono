            ...
            <div className="*:not-first:mt-2">
              <div className="relative">
                <Input
                  ...
                  type="search"
                />
                <div className="text-muted-foreground/80 pointer-events-none absolute inset-y-0 start-0 flex items-center justify-center ps-3 !text-base peer-disabled:opacity-50">
                  <SearchIcon size={16} />
                </div>
              </div>
            </div>
