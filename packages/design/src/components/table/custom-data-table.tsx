...
interface CustomDataTablePropsWithOptionalFilter
  extends BaseCustomDataTableProps {
  filter?: never;
  filterKeys?: never;
}

// Props with required filter configuration
interface CustomDataTablePropsWithFilter<T = any>
  extends BaseCustomDataTableProps {
  data: T[];
...
export type CustomDataTableProps<T = any> =
  | CustomDataTablePropsWithOptionalFilter
  | CustomDataTablePropsWithFilter<T>;
...
export const CustomDataTable = <T = any,>({
  ...
  return (
    <div
      className={cn("bg-primary/5 space-y-2 rounded-2xl px-1 py-3", className)}
    >
      {/* Search and Controls */}
      {(searchable ||
        showSeeAll ||
            ...
            {searchable && (
              <div className="relative max-w-sm flex-1">
                ...
                <Input
                  ...
                  className="pr-10 pl-10 shadow-none focus-visible:shadow-none focus-visible:ring-0 sm:rounded-none sm:border-0 sm:focus-visible:border-0"
                />
                {/* Clear search button */}
                {searchTerm && (
                  <Button
                ...
                <TableRow>
                  ...
                  {tableColumns.map((column) => (
                    <TableHead
                      ...
                      className={cn(
                        column.sortable &&
                          "hover:bg-primary/5 cursor-pointer select-none",
                        column.className,
                      )}
