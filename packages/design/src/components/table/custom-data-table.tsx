...
export const CustomDataTable = <T = any,>({
  ...
  return (
    <div className={cn("bg-secondary space-y-1 px-1", className)}>
      {/* Search and Controls */}
      {(searchable ||
        showSeeAll ||
            ...
            {searchable && (
              <div className="relative max-w-sm flex-1">
                ...
                <Input
                  ...
                  className="pr-10 pl-10 focus-visible:shadow-none focus-visible:ring-0 sm:rounded-none sm:border-0 sm:focus-visible:border-0"
                />
                {/* Clear search button */}
                {searchTerm && (
                  <Button
