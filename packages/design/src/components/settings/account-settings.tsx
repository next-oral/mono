...
const updateAccountSchema = z.object({
  ...
  firstName: z.string().min(3, {message: "First name cannot be less than 3 characters long"}).optional(),
  lastName: z.string().min(3, {message: "Last name cannot be less than 3 characters long"}).optional(),
  phoneNumber: z
    .string()
    .trim()
    .transform((val) => {
    ...
    age: z.string().min(1, { message: "Age cannot be less than 1 character" }).max(3, { message: "Age cannot be more than 3 characters" }).refine((val) => {
...
const deleteAccountSchema = z.object({
  ...
  email: z.string().min(1, "Email is required for confirmation"),
});
      ...
      <section className="flex w-full flex-wrap justify-between gap-10">
        <div className="flex flex-grow flex-col gap-1">
          ...
          <p className="text-xs sm:text-sm">
            Update your personal information, it helps us know more about you. 
          </p>
        </div>
        ...
        <div className="flex-grow">
          <Form {...updateAccountForm}>
            ...
            >
              ...
              <Button type="submit" className="mt-4 px-8" aria-label="Save profile changes">Save Changes</Button>
            </form>
          </Form>
        </div>
      </section>
      ...
      <section className="flex w-full flex-col gap-6">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              variant="destructive"
              className="bg-destructive/20 text-secondary-foreground border-destructive/40 hover:bg-destructive/60 size-fit border px-4 py-3 transition-colors duration-400"
            >
              Delete Account
            </Button>
          </DialogTrigger>
          ...
          >
            ...
            <Form {...deleteAccountForm}>
              <form
                onSubmit={deleteAccountForm.handleSubmit(handleAccountDelete)}
              >
                <CustomCommandField
            ...
            <DialogFooter>
              ...
              <Button
                variant={deleteProcessState === 2 ? "destructive" : "default"}
